...
<body>
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 250px; min-height: 200vh; height: max-content;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <a href="https://web-production-0b5d.up.railway.app/" class="btn btn-outline-light mb-3" style="margin-top: 1rem;">Kembali Ke Portofolio</a>
        </ul>
    </div>
</body>
</html>